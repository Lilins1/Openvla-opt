...
#SBATCH --output=logs/libero_actionpre_out_%j.txt
#SBATCH --error=logs/libero_actionpre_err_%j.txt
#SBATCH --nodes=1
...
torchrun --standalone --nnodes 1 --nproc-per-node 1 vla-scripts/finetune_RNN.py \
  ...
  --run_root_dir /mimer/NOBACKUP/groups/naiss2024-5-164/Ruizhe/OPENVLA/rnn_model/action/libero/lora_train \
  --use_film False \
