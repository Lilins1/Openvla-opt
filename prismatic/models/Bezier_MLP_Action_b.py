...
class Bezier_MLP_Action_b(nn.Module):
    """
    ...
    def __init__(self,
                 ...
                 dropout=0.1):
        super(Bezier_MLP_Action_b, self).__init__()

        self.fc1 = nn.Linear(input_dim * action_dim * ACTION_CHUNK_PER_CURVE, mlp_hidden_size)
    ...
    def predict_action(self, actions_hidden_states):
        ...
        placeholder_expanded = self.placeholder.expand(B, ACTION_DIM, hidden_dim)  # (B,1,hidden_dim)
        ...
        x = x.reshape(B_new * seq_len, hidden_dim * ACTION_DIM * ACTION_CHUNK_PER_CURVE)  # (B*4, hidden_dim)
